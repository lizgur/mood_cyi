        ...
        <div className="container">
          <div className="row justify-center">
            ...
            <div className="col-10 md:col-8 lg:col-6">
              <div className="h-[323px] md:h-[623px] rounded-md animate-pulse bg-neutral-200  mb-4"></div>
                ...
                {Array(4)
                  ...
                  .map((_, index) => {
                    return (
                      <div
                        key={index}
                        className="h-[80px] md:h-[146px] rounded-md animate-pulse bg-neutral-200 "
                      ></div>
                    );
                  })}
              </div>
              ...
              {Array(8)
                ...
                .map((_, index) => {
                  return (
                    <div
                      key={index}
                      className="h-20 mb-4 rounded-md animate-pulse bg-neutral-200 "
                    ></div>
                  );
                })}
            </div>
